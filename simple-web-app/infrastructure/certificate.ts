...
import { ACM } from './.gen/providers/aws'
 ...
 */
export interface ICertificateConstructProps {
...
export class CertificateConstruct extends Construct {
  ...
  readonly acmCertificate: ACM.AcmCertificate
   ...
   */
  constructor(scope: Construct, id: string, props: ICertificateConstructProps) {
    super(scope, id)
    ...
    this.acmCertificate = new ACM.AcmCertificate(this, "acm_certificate", {
